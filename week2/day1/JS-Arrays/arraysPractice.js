...
// //(that will be passed in as a parameter) to see if that random number is in the
...
/*
  ...
  Specrunner will try to call your functions without passing in valid aurguments. When this happens, you will need to
